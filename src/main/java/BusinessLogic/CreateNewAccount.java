...
public class CreateNewAccount {
    ...
    public static void createNewAccount(String username, String password, String email, int userType, String firstName, String lastName) throws HashCode.CannotPerformOperationException {
        if(userType == 0){
